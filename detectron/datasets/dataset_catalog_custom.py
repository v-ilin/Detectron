...
DATASETS = {
    ...
    'hardhat_gloves_goggles_3_train': {
        IM_DIR: _DATA_DIR + '/hardhat_gloves_goggles_3/train',
        ANN_FN: _DATA_DIR + '/hardhat_gloves_goggles_3/annotations/instances_train.json'
    },
    'hardhat_gloves_goggles_3_val': {
        IM_DIR: _DATA_DIR + '/hardhat_gloves_goggles_3/val',
        ANN_FN: _DATA_DIR + '/hardhat_gloves_goggles_3/annotations/instances_val.json'
    }
}
